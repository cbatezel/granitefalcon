    ...
    <div className="min-h-screen bg-[#f5f0e8] text-[#0d0d0d] overflow-x-hidden">
      ...
      <div className={`fixed top-5 left-1/2 -translate-x-1/2 z-50 transition-all duration-700 ${showIsland ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4 pointer-events-none"}`}>
        <div className="island-nav flex items-center gap-1 px-2 py-1.5 bg-[#0d0d0d]/90 backdrop-blur-xl rounded-full shadow-2xl shadow-black/20">
          {[{ id: "process", label: "Process" }, { id: "results", label: "Results" }, { id: "pricing", label: "Pricing" }, { id: "team", label: "Team" }].map((link) => (
            <a key={link.id} href={`#${link.id}`} className={`px-3.5 py-1.5 rounded-full text-[11px] font-sans tracking-[0.06em] transition-all duration-300 ${active === link.id ? "bg-white/15 text-white" : "text-white/50 hover:text-white/80"}`}>
              {link.label}
            </a>
          ))}
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 pt-20 pb-28 md:pt-28 md:pb-40 relative z-10">
          ...
          <p className="hero-fade font-sans text-[11px] md:text-xs tracking-[0.2em] uppercase text-[#0d0d0d]/35 mb-8">Human Solutions for a Robot World</p>

          <h1 className="hero-headline font-serif text-[clamp(3rem,9vw,8rem)] leading-[0.96] tracking-tight max-w-5xl">
            You didn&apos;t start<br />your business to<br /><span className="text-[#0d0d0d]/22">drown in busywork.</span>
          </h1>

          <p className="hero-fade hero-fade-2 font-sans text-lg md:text-xl text-[#0d0d0d]/50 mt-12 max-w-lg leading-relaxed">We build quiet tools that take the grunt work off your plate — so you can get back to the work only you can do.</p>
          ...
          <div className="hero-fade hero-fade-3 mt-14 flex items-center gap-5">
            ...
            <span className="text-[11px] font-sans text-[#0d0d0d]/28">15 min · No pitch · Just honest answers</span>
          </div>
        </div>
      </section>
      ...
      <section id="process" className="bg-[#0d0d0d] text-white">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-32 md:py-44">
          <Reveal>
            <p className="text-[11px] font-sans font-medium tracking-[0.2em] uppercase text-white/30 mb-6">Process</p>
            <p className="font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight max-w-2xl mb-6">
              Good work, <span className="text-white/30">faster than you thought possible.</span>
            </p>
            <p className="font-sans text-sm text-white/35 max-w-md leading-relaxed mb-28">We move at the speed of your problem — not the speed of a committee. Real results, often in a week.</p>
          </Reveal>
            ...
            <Reveal key={step.num} delay={i * 120}>
              <div className="process-row grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 py-12 md:py-16 border-t border-white/6 items-baseline">
                ...
                <div className="md:col-span-7 md:col-start-6">
                  <p className="font-sans text-base text-white/45 leading-relaxed">{step.text}</p>
                </div>
              </div>
            </Reveal>
          ))}
      ...
      <section id="results">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-32 md:py-44">
          <Reveal>
            <p className="text-[11px] font-sans font-medium tracking-[0.2em] uppercase text-[#0d0d0d]/35 mb-6">Results</p>
            <p className="font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight max-w-2xl mb-28">
              Real-world results.{" "}<span className="text-[#0d0d0d]/25">Not hypotheticals.</span>
            </p>
          </Reveal>
                ...
                <div className="case-study border-t border-[#0d0d0d]/8 py-16 md:py-20">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10">
                    ...
                    <div className="md:col-span-4">
                      ...
                      <p className="font-sans text-sm text-[#0d0d0d]/40 mt-3">
                        {study.unit && <span>{study.unit} </span>}{study.label}
                      </p>
                      <p className="font-sans text-xs text-[#0d0d0d]/30 mt-1 tracking-wide uppercase">{study.client}</p>
                    </div>

                    {/* Story */}
                    <div className="md:col-span-7 md:col-start-6 flex flex-col justify-between">
                      <div>
                        <p className="font-sans text-sm text-[#0d0d0d]/55 leading-relaxed mb-4">{study.story}</p>
                        <p className="font-sans text-sm text-[#0d0d0d]/65 leading-relaxed font-medium">{study.solution}</p>
                      </div>
                      <div className="mt-10 border-l-2 border-[#F5C842]/40 pl-5">
                        <p className="font-serif text-lg italic text-[#0d0d0d]/50 leading-snug">&ldquo;{study.quote}&rdquo;</p>
                        <p className="font-sans text-[11px] text-[#0d0d0d]/30 mt-3">{study.name}, {study.title}</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section id="pricing" className="border-t border-[#0d0d0d]/6">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-28 md:py-36">
          <Reveal>
            <p className="text-[11px] font-sans font-medium tracking-[0.2em] uppercase text-[#0d0d0d]/35 mb-5">Pricing</p>
            <p className="font-serif text-3xl md:text-4xl leading-snug tracking-tight max-w-lg mb-20">Simple pricing. <span className="text-[#0d0d0d]/25">No surprises.</span></p>
          </Reveal>
          ...
          <Reveal delay={200}><p className="font-sans text-sm text-[#0d0d0d]/35 mt-10 text-center">Monthly retainer options available for ongoing support.</p></Reveal>
        </div>
      </section>
      ...
      <section id="team" className="bg-[#0d0d0d] text-white">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-32 md:py-44">
          <Reveal>
            <p className="text-[11px] font-sans font-medium tracking-[0.2em] uppercase text-white/30 mb-6">Our Team</p>
            <p className="font-serif text-4xl md:text-5xl leading-[1.08] tracking-tight max-w-xl mb-20">
              Real people.{" "}<span className="text-white/30">A deep bench of world-class talent.</span>
            </p>
          </Reveal>
            ...
            <Reveal delay={100}>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="font-sans text-sm text-white/40 leading-relaxed">15+ years producing documentaries, live events, and complex productions around the world. He makes complicated operations look effortless — and builds tools with that same precision.</p>
                </div>
              </div>
            </Reveal>
            <Reveal delay={200}>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="font-sans text-sm text-white/40 leading-relaxed">Background in photojournalism, master&apos;s in organizational leadership. He turns ambiguity into action — asking the right questions, building durable systems, and making teams faster.</p>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <Reveal>
            <div className="border-t border-white/6 pt-16">
              <p className="font-sans text-sm text-white/45 max-w-lg leading-relaxed mb-10">
              ...
              <div className="flex flex-wrap gap-3">
                {capabilities.map((cap, i) => (
                  <span key={cap} className="capability-tag px-5 py-2.5 border border-white/8 text-xs font-sans tracking-wide text-white/40 hover:border-[#F5C842]/40 hover:text-white/65 transition-all duration-500 cursor-default" style={{ transitionDelay: `${i * 40}ms` }}>
                    {cap}
                  </span>
                ))}
              </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-28 md:py-36 text-center">
          <Reveal>
            <p className="font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
              Stop drowning in<br /><span className="text-[#0d0d0d]/22">the day-to-day.</span>
            </p>
          </Reveal>
          <Reveal delay={100}>
            <p className="font-sans text-sm text-[#0d0d0d]/45 mt-8 max-w-md mx-auto leading-relaxed">Book a free 15-minute call. We&apos;ll listen, ask the right questions, and tell you honestly whether we can help.</p>
          </Reveal>
          <Reveal delay={180}>
      ...
      <footer className="border-t border-[#0d0d0d]/6">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <span className="font-serif text-base text-[#0d0d0d]/35">AI Delivered</span>
          <div className="font-sans text-xs text-[#0d0d0d]/28 flex gap-6">
